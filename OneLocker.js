var login_protocol = function(){
	...
	if (username === "student1" || username === "athomas1"){
		...
		if (password === "athomas5149" || password === "thomaslocker"){
			...
			<p><a href="#logout" style="font-size: 16px;">Go to top</a></p>\
			<div class="links">\
			<a href="https://accounts.google.com/AccountChooser?source=ogb&continue=https%3A%2F%2Fwww.google.com%2Fwebhp%3Fauthuser%3D&Email=shwin320%40gmail.com" target="_blank"><img src="https://pbs.twimg.com/profile_images/839721704163155970/LI_TRk1z_400x400.jpg" class="hoverer" width=100 height=100 style="margin-top: 40px;"></a>\
			...
			<a href="https://my.hrw.com/sp/access?sp=hrw&connection=lmtsd-org" target="_blank"><img src="https://www-k6.thinkcentral.com/ePCLandingPage/lpassets/images/thumb/HoltMcDougalOnline.gif" width=162.5 height=125></a>\
			...
			<a href="https://montcolibs.overdrive.com/mclinc-huntingdonvalley/content" target="_blank"><img src="https://company.overdrive.com/wp-content/uploads/2016/11/OverDrive_Logo-2015_rgb.png" width=431.6 height=112.6 style="margin-top: 40px;"></a>\
